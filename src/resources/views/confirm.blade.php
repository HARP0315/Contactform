...
<div class="confirm-page">
    ...
    <div class="confirm-page__content">
        ...
        {{-- 修正ボタン --}}
        <div class="confirm-page__back-form-wrap">
            <form class="confirm-form confirm-form--back" action="/" method="post">
                @csrf
                <input type="hidden" name="category_id" value="{{ $contact['category_id'] }}">
                <input type="hidden" name="last_name" value="{{ $contact['last_name'] }}">
                <input type="hidden" name="first_name" value="{{ $contact['first_name'] }}">
                ...
                <input type="hidden" name="building" value="{{ $contact['building'] }}">
                <input type="hidden" name="detail" value="{{ $contact['detail'] }}">
                <button type="submit" class="confirm-form__button confirm-form__button--back">修正</button>
            </form>
        </div>
    </div>
</div>
